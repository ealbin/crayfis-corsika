...
//{""},
{"  -A <num>   --nucleons=<num>   none                 <num> is the (int) Atomic Number"},
...
{"                                                     Default: 112.8_km"},
//{""},
{"  -i <num>   --impact=<num>     _m       Advised     Altitude of first collision of"},
...
{"                                                     Default: 0.20946"},
//{""},
{"  -Z <num>   --protons=<num>    none     Yes         <num> is the (int) Atomic Number of"},
